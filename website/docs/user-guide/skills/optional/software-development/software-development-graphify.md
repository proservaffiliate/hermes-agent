---
title: "Graphify"
sidebar_label: "Graphify"
description: "Use for any question about a codebase, its architecture, file relationships, or project content — especially when graphify-out/ exists, where the question sh..."
---
...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/software-development/graphify` |
| Path | `optional-skills/software-development/graphify` |
| Version | `1.0.0` |
| Author | Graphify-Labs |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Knowledge-Graph`, `Architecture`, `Code-Analysis`, `Graph`, `Visualization`, `GraphRAG` |
| Related skills | [`code-wiki`](/docs/user-guide/skills/optional/software-development/software-development-code-wiki), [`subagent-driven-development`](/docs/user-guide/skills/optional/software-development/software-development-subagent-driven-development), [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging) |
